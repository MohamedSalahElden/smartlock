...
#if (LCD_MODE == 4)
#ifndef MASK
#define MASK 0xF0		/*change this value from 0x0F to 0xF0 to either select the upper 4 bits or lower one 0xF0 = upper 4 bits*/
#endif
#elif(LCD_MODE == 8)
#define MASK 0xFF
#else
#error "LCD mode must be a number 4 or 8"
#endif
...
#ifndef DATA_PORT
#define DATA_PORT {portC , MASK , output , none}
#endif
#ifndef RS_PIN
#define RS_PIN {portD , pin4 , output , none}
#endif
#ifndef RW_PIN
#define RW_PIN {portD , pin5 , output , none}
#endif
#ifndef E_PIN
#define E_PIN  {portD , pin6 , output , none}
#endif
#ifndef V0_PIN
#define V0_PIN {portA , pin3 , output , none}
#endif
